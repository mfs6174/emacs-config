...
\usepackage[slantfont, boldfont,CJKnormalspaces]{xeCJK} 
...
%保留中文内部的空格,我认为这样才符合正常逻辑,不知道为何默认是false
%允许直接在公式中输入中文
...
% \setCJKmainfont[BoldFont=WenQuanYi Micro Hei Mono]{WenQuanYi Micro Hei Mono}   % 设置缺省中文字体
% \setCJKsansfont[BoldFont=WenQuanYi Micro Hei Mono]{WenQuanYi Micro Hei Mono}  % 设置中文无衬线字体
...
\setCJKmainfont[BoldFont={WenQuanYi Micro Hei Mono}, ItalicFont={AR PL KaitiM GB}]{AR PL SungtiL GB}
\setCJKsansfont{AR PL KaitiM GB}
\setCJKmonofont{王汉宗中仿宋简}

\setCJKfamilyfont{song}{AR PL SungtiL GB}                     
\setCJKfamilyfont{kai}{AR PL KaitiM GB}
\setCJKfamilyfont{hei}{WenQuanYi Micro Hei Mono}
\setCJKfamilyfont{yao}{方正姚体_GBK}
\setCJKfamilyfont{fs}{王汉宗中仿宋简}
...
%%%%%%%%%%%%%%%%%%%%%%%%%正文部分%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\renewcommand{\normalsize}{\xiaosi}         % 设定正文字体大小
\setlength{\parindent}{2em}                    
% 设定首行缩进为2em。注意此设置一定要在document环境之中。
% 这可能与\setlength作用范围相关
\setcounter{secnumdepth}{5}
\title{这是题目}
\author{这是作者 可以多行\\xijinz@acm.org}
\maketitle
%%%%%titlepage%%%%
% 自己定义标题页
% \begin{titlepage}      
% \vspace{20pt}
% \erhao{\textbf{浙江大学本科生院教学研究处\\浙江大学数学建模实践基地}}
% \end{center}
%%%%titlepage end%%%%
...
%     \toprule
%     序号 & 名称 & 纬度(N) & 经度(E) & $X(km)$ & $Y(km)$\\
%     \midrule
%     1 & 永兴岛 & 16.8333 & 112.333 & 535.491 &1861.89  \\
%     \bottomrule
%   \end{tabular}
%   \caption{西沙群岛}
% \end{table}
...
% \bibitem{cls} 经纬度坐标转平面坐标，http://hi.baidu.com/clsiahzlxlbblnd/item/49e4d14cb91459e91281dae6,\today
% \bibitem{rtsp} 宋勃. 求解现实旅行商问题的算法研究.河北工业大学硕士学位论文-计算机应用技术,2008.11.01.
% \end{thebibliography}
